...
export { adicionaQuestaoMultiplaEscolha } from './questoes/questao-multipla-escolha.service'
export { retornaQuestoesMultiplaEscolhas } from './questoes/questao-multipla-escolha.service'

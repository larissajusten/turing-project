  ...
  render() {
    const data = [
      {
        ...
        linguagem: this.props.tecnologias[0].quantosUsuarios,
        amt: 100,
      },
      {
        name: this.props.tecnologias[1].especificidade.toLowerCase(),
        linguagem: this.props.tecnologias[1].quantosUsuarios,
        amt: 2,
      },
      {
        name: this.props.tecnologias[2].especificidade.toLowerCase(),
        linguagem: this.props.tecnologias[2].quantosUsuarios,
        amt: 2290,
      },
      {
        name: this.props.tecnologias[3].especificidade.toLowerCase(),
        linguagem: this.props.tecnologias[3].quantosUsuarios,
        amt: 2000,
      },
      {
        name: this.props.tecnologias[4].especificidade.toLowerCase(),
        linguagem: this.props.tecnologias[4].quantosUsuarios,
        amt: 2181,
      },
      {
        name: this.props.tecnologias[5].especificidade.toLowerCase(),
        linguagem: this.props.tecnologias[5].quantosUsuarios, 
        amt: 2390
      },
      {
        name: this.props.tecnologias[6].especificidade.toLowerCase(),
        linguagem: this.props.tecnologias[6].quantosUsuarios,
        amt: 2100,
      },
      {
        name: this.props.tecnologias[7].especificidade.toLowerCase(),
        linguagem: this.props.tecnologias[7].quantosUsuarios,
        amt: 2100,
      },
    ]
    ...
    return (
      ...
      <BarChart
        ...
        <Tooltip/>
        <Bar barSize={25} dataKey="linguagem" fill='#000000' label={label(this.props.tecnologias)}>
          {
          	data.map((item, index) => {

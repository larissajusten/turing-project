  ...
  props.questoes.map((item, key) => {
    return <View style={styles.container} key={key}>
            ...
            <View style={styles.containerResposta}>
              <Text style={item.alternativaA.respostaCorreta ? styles.respostaCorreta : styles.resposta}>
                {`1. ${item.alternativaA.resposta}`}
              </Text>
              <Text style={item.alternativaB.respostaCorreta ? styles.respostaCorreta : styles.resposta}>
                {`1. ${item.alternativaB.resposta}`}
              </Text>
              <Text style={item.alternativaC.respostaCorreta ? styles.respostaCorreta : styles.resposta}>
                {`1. ${item.alternativaC.resposta}`}
              </Text>
              <Text style={item.alternativaD.respostaCorreta ? styles.respostaCorreta : styles.resposta}>
                {`1. ${item.alternativaD.resposta}`}
              </Text>
              <Text style={item.alternativaE.respostaCorreta ? styles.respostaCorreta : styles.resposta}>

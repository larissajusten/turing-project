...
public class BuscarQuestoesMultiplaEscolhaFiltradasServiceTest {
    ...
    public void deveChamarQuestaoMultiplaEscolhaRepositoryQuestaoBuscarQuestoesMultiplaEscolhaFiltradasService() {
        ...
        Mockito.when(repository.acharListaMultiplaEscolhaFiltrada(Especificidade.JAVASCRIPT, NivelDeDificuldade.FACIL))
        ...
        Mockito.verify(repository).acharListaMultiplaEscolhaFiltrada(Especificidade.JAVASCRIPT, NivelDeDificuldade.FACIL);
    }

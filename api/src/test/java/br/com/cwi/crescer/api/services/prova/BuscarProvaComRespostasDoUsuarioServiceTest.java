...
public class BuscarProvaComRespostasDoUsuarioServiceTest {

    @InjectMocks
    BuscarProvaComRespostasDoUsuarioService buscarProvaComRespostasDoUsuarioService;
    ...
    public void deveChamarbuscarProvaPorIdServiceQuandoBuscarProvaComRespostasDoUsuarioServiceForChamado() {
        ...
        buscarProvaComRespostasDoUsuarioService.buscar(prova.getId());

...
//
//        Mockito.when(provaRepository.findByEmailCandidatoContainingOrNomeCandidatoContainingAndStatusEquals("Va", StatusProva.CORRIGIDA)).thenReturn(provas);
//
//        buscarProvasCorrigidasComNotaService.buscar("Va");
//
//        Mockito.verify(provaRepository).findByEmailCandidatoContainingOrNomeCandidatoContainingAndStatusEquals("Va", StatusProva.CORRIGIDA);
//    }
//
//    @Test
